...
let tyrannosaurus = { name: 'tyrannosaurus', diet: 'carnivorous', weight: '7000kg', length: '12m', period: 'Late Cretaceous' };

// stegosaurus, herbivorous, 2000kg, 9m, Late Jurassic
let stegosaurus = { name: 'stegosaurus', diet: 'herbivorous', weight: '2000kg', length: '9m', period: 'Late Jurassic' };

// velociraptor, carnivorous, 15kg, 1.8m, Late Cretaceous
let velociraptor = { name: 'velociraptor', diet: 'carnivorous', weight: '15kg', length: '1.8m', period: 'Late Cretaceous' };
...
for (const graduate of graduates) {
  if (graduate.university.toLowerCase().includes('uni')) {
...
*/
const populationByAnimals = zooAnimals.map(animal => animal.population);
const populationTotal = populationByAnimals.reduce((accumulator, currentValue) => accumulator + currentValue);
